            ...
            var l = function (e) {
                    ...
                    l = a.default.useMemo(
                        function () {
                            var t = (0, u.resolveHref)(o, e.href, !0),
                                ...
                                a = n[0],
                                i = n[1];
                            return { href: a, as: e.as ? (0, u.resolveHref)(o, e.as) : i || a };
                        },
                        [o, e.href, e.as]
                    ),
                    d = l.href,
                ...
                var b = a.Children.only(v),
                    ...
                    k = a.default.useCallback(
                        function (e) {
                            I(e), M && ("function" === typeof M ? M(e) : "object" === typeof M && (M.current = e));
                        },
                        [M, I]
                    );
                (0, a.useEffect)(
                    function () {
                        var e = C && t && (0, u.isLocalURL)(d),
                ...
                var E = {
                    ...
                    onMouseEnter: function (e) {
                        (0, u.isLocalURL)(d) && (b.props && "function" === typeof b.props.onMouseEnter && b.props.onMouseEnter(e), s(n, d, p, { priority: !0 }));
                    },
                };
                return (e.passHref || ("a" === b.type && !("href" in b.props))) && (E.href = (0, u.addBasePath)((0, u.addLocale)(p, "undefined" !== typeof g ? g : n && n.locale, n && n.defaultLocale))), a.default.cloneElement(b, E);
            };
            t.default = l;
        },
        lSNA: function (e, t) {
                                        ...
                                        (e &&
                                            ...
                                            (o.current = (function (e, t, n) {
                                                ...
                                                return (
                                                    ...
                                                    a.observe(e),
                                                    function () {
                                                        a.unobserve(e), 0 === u.size && (a.disconnect(), c.delete(o));
                                                    }
                                                );
                                            })(
                                                e,
